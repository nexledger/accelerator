...
func (t *SmallbankChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
	...
	switch function {
	case "create_account":
		return invoke(stub, t.CreateAccount)
	case "transact_savings":
		return invoke(stub, t.TransactSavings)
	case "deposit_checking":
		return invoke(stub, t.DepositChecking)
	case "send_payment":
		return invoke(stub, t.SendPayment)
	case "write_check":
		return invoke(stub, t.WriteCheck)
	case "amalgamate":
		return invoke(stub, t.Amalgamate)
	case "query":
